        ...
        for(;;)
        {
                ...
                if ( ((unsigned short)(system_ticks - end_timer)) > 50)
                {
                        ...
                        cctrl_func.Asi5ReadASi5Idi(0, asi5_idi, &length, 1);			// es werden 2 bytes von bwu8334 gelesen
                        	...
                        	if ( (  ((asi5_idi[1]<<8)|asi5_idi[0]) & (0x01 << 11))) {	/* wenn an port 12 HIGH anliegt, dann,...
                        																	(Hinweis: funktioniert nur, wenn der Port bevor das
                        																	Programm auf controller geladen wird, beschaltet ist,
                        																	also die LED orange leuchtet.) */
                        		asi5_odi[0] = 0x00;
                        		asi5_odi[1] = 0x01;										// port 9 schalten
                        	    cctrl_func.Asi5WriteASi5Odi(0, asi5_odi, 2, 1);			// odi schreiben
                        	}
							else {
								asi5_odi[0] = 0x00;
								asi5_odi[1] = 0x00;
								cctrl_func.Asi5WriteASi5Odi(0, asi5_odi, 2, 1);
							}
